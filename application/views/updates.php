              ...
              <div class="box"><!-- Start box for parameters -->
                ...
                <div class="box-body">
                      ...
                      <div class="input-group">
                        ...
                        <div class="input-group">
                          ...
                          <select class="form-control filter-control" id="module">
                            ...
                            <option value="ModComments">Comments</option>
                          </select>
                        </div>
                    </div>
                  </div>
                    ...
                    <div class="alert alert-warning">
                      <div class="input-group">
                        ...
                        <select id="fieldname" class="form-control">
                            <option value="label">Related to</option>
                            <option value="whodid">Updated by</option>
                        </select>
                      </div>
                        <br>
                  ...
                  <div class="col-sm-1 alert-success text-center">
                    <h1><?php echo $tracks_today ?></h1>Today<br>
                  </div>
                </div>
              </div><!-- /. box fir parameters -->
            </div>

            <div class="col-md-12 well" style="margin-left: 10px" id="updateContainer">
 ...
 <!--SECTION FOR FEEDBACKS-->   
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function(){
        ...
        $.post("<?php echo base_url() ?>updates/tracks",function(data){
              $("#updateContainer").parent().addClass('text-center');
              $("#updateContainer").html("<img src='<?php echo base_url() ?>/assets/dist/img/loader.gif' width='100px'>");

              $("#updateContainer").html(data);
              $("#updateContainer").parent().removeClass('text-center');
        },"html");
        ...
        $(document).on('change','.filter-control',function(){
          ...
          /*
            AJAX to call filtered updates
          */
          $.post("<?php echo base_url() ?>updates/tracks_filtered",{campaign : campaign, module : module, fieldname : fieldname, keyword : keyword, startdate : startdate, enddate : enddate},function(data){
                $("#updateContainer").parent().addClass('text-center');
                $("#updateContainer").html("<img src='<?php echo base_url() ?>/assets/dist/img/loader.gif' width='100px'>");
